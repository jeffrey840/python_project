...
#     url = "https://zillow-com1.p.rapidapi.com/propertyExtendedSearch&status_type=ForRent"
...
# def main():
#     zipcodes = ["77091" ]  # Add more zip codes as needed
#     for zipcode in zipcodes:
#         page = 1
#         while True:
#             data = fetch_zillow_listings(zipcode, page)
#             if "error" not in data:
#                 filename = f"zillow_listings_{zipcode}_page{page}_for_rent.json"
